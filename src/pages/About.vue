<template>
  <section class="sec2 about">
    ...
    <!-- About container -->
    <div class="grid grid-cols-2 pt-14 pb-20">
      <!-- about-container -->
      <div class="pr-20">
        <!-- left-about -->
        <h4 class="text-3xl uppercase font-bold">Information About me</h4>
        <p class="leading-8 p-4 text-gris1">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequuntur
          possimus aliquid nisi repellendus soluta velit blanditiis reiciendis
          ratione totam ullam earum eaque facilis, minus quibusdam aliquam
          assumenda libero illo beatae.
        </p>
        <boton></boton>
        <!-- CV Download -->
      </div>
      <div class="grid grid-cols-2 gap-8">
        ...
        >
          ...
          <div class="p-6 flex flex-col">
            <!-- abt-text -->
            <p class="text-5xl font-bold text-secundario">560+</p>
            <!-- large-text -->
            <p
              class="pl-12 relative uppercase text-xl text-gris1 tracking-widest small-text"
            >
              Projects <br />
              Completed
            </p>
    ...
    <div class="pb-16">
      <!-- stat-title2 -->
      <h4 class="font-bold uppercase text-2xl text-center py-14 px-0 relative stat-title">My Timeline</h4>
      <!-- Timeline/ Jobs -->
